...
public class RedWhiteBlue {
     ...
     * 
     * @param arr		Array of ints with values of only 0s, 1s, and 2s. Note
     *                  that if arr contains a value that is not 0, 1, or 2 then
     *                  the method will pass it without sorting it. If array is
     *                  empty then nothing happens.
     */
    public static void dutchFlagA (int arr []) {
        System.out.println("This array started as");
        printArray (arr);
     ...
     * 1s then 2s originally in the array. This is completed in O(n) time.
     * 
     * @param arr	     Array of ints with values of only 0s, 1s, and 2s. Note that
     *                   if arr has a value that is not 0, 1, or 2 then the method
     *                   will not terminate. If the array is empty then nothing happens.
     */
    ...
    public static void main (String [] args) {
        ...
        RedWhiteBlue.dutchFlagA (empArr);
        ...
        RedWhiteBlue.dutchFlagC (empArr);
    }
}

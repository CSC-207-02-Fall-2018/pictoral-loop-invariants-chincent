...
/**
 * This class implements the partition method in order to develop a
 * quicksort algorithm. It has no fields thus the methods are all
 * static.
 * 
 * @author Vincent Noh and Chase Snodgrass
 *
 */
public class Partition {
	...
	public static int partition (int [] arr, int left, int right) {
		...
		// In case of a size 2 array, manually check two data points
		if (right - left == 2) {
		...
		// In case of size 1 array, return element
		if(l_spot == right) {
